      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 text-base text-slate-600 dark:text-slate-300">{t('converter.description')}</p>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          <div className="space-y-5">
            <div>
              <label htmlFor="videoInput" className="text-sm font-medium text-slate-700 dark:text-slate-200">
            ...
            {isBusy && (
              <div className="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-300">
                <div className="h-2 w-full rounded-full bg-slate-100 dark:bg-slate-700/80">
                  <div className="h-2 rounded-full bg-blue-500 transition-all dark:bg-blue-400" style={{ width: `${progress}%` }} />
                </div>
                <span>{progress}%</span>
              </div>
            )}
            ...
            {gifUrl && (
              <div className="mt-4 space-y-3">
                ...
                <img
                  ...
                  className="max-h-80 w-full rounded-xl border border-slate-200 object-contain dark:border-slate-600"
                />
                <a
                  href={gifUrl}
